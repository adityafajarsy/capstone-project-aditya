          ...
          <div className="flex items-center gap-4">
            <div className="sm:flex sm:gap-4">
              ...
              <Link to="/cart">
                      ...
                      <div class="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-500 border-2 border-white rounded-full top-4 mx-5">1</div>
                    </Link>
              </div>
            </div>
